	...
	CountTime.fn = CountTime.prototype = {
		...
		update : function(time, minus){
				...
				if ( ( TodaysDate.getDate() < CountdownDate.getDate() && (TodaysDate.getMonth() + 1) <= ( CountdownDate.getMonth() + 1 ) ) || CountTime.fn.minus)
				{
					...
					time = "<div class=\"grid2\">"+daysLeft + "<br /><span class=\"small\">days</span></div> <div class=\"grid2\">" + hrsLeft +"<br /> <span class=\"small\">hours</span></div> <div class=\"grid2\">" + minsLeft + "<br /> <span class=\"small\">mins</span></div> <div class=\"grid2\">" + secLeft + "<br /><span class=\"small\">secs</span></div>";
				}
				else
				{
					//time = "0 : 0 : 0 : 0";
					
						time = "<div class=\"grid2\">"+00 + "<br /><span class=\"small\">days</span></div> <div class=\"grid2\">" + 00 +"<br /> <span class=\"small\">hours</span></div> <div class=\"grid2\">" + 00 + "<br /> <span class=\"small\">mins</span></div> <div class=\"grid2\">" + 00 + "<br /><span class=\"small\">secs</span></div>";
